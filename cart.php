        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <?php
                        if (isset($resultSLHC) && isset($resultSLHC['soLuongSanPham'])) {
                            // Stock available in the database for the product
                            $soluonghienco = $resultSLHC['soLuongSanPham'];
                        } else {
                            // If the result is not available, default to 0 or handle the error as needed
                            $soluonghienco = 0;
                        }
                
                        // Check if the cart quantity is greater than 0
                        if (isset($_SESSION['soluong']) && $_SESSION['soluong'] > 0) {
                            // Check if the cart quantity is less than or equal to the available stock
                            if ($_SESSION['soluong'] <= $soluonghienco) {
                                ...
                                // If the cart quantity exceeds the available stock, show an alert
                                echo '<input type="submit" class="procedtocheckout" value="Thanh Toán" style="color: white;" onClick="alert(\'Số lượng trong giỏ hàng vượt quá số lượng tồn kho.\')";>';
                            }
                        } else {
